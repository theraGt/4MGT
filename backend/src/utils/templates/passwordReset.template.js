export const passwordResetTokenTemplate = (nombre, token) => {
    return `
    <!DOCTYPE html>
    <html lang="es">
    ...
    <head>
        ...
        <title>Recuperación de contraseña - 4M</title>
    </head>
                        ...
                        <tr>
                            <td style="padding: 45px 40px;">
                                ...
                                <p style="font-size: 16px; line-height: 1.7; color: #D8C6BE;">
                                    Recibimos una solicitud para restablecer la contraseña de tu cuenta <strong style="color: #F1C40F;">4M</strong>.
                                </p>
                                <p style="font-size: 16px; line-height: 1.7; color: #D8C6BE;">
                                    Utiliza el siguiente código de recuperación:
                                </p>
                                ...
                                <p style="font-size: 14px; color: #A08D84; line-height: 1.6;">
                                    ⚠️ Este código es temporal y expirará en los próximos minutos por seguridad.
                                </p>
