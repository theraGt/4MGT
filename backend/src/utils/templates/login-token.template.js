export const loginTokenTemplate = (nombre, token) => {
    return `
    <!DOCTYPE html>
    <html lang="es">
    ...
    <head>
        ...
        <title>Código de acceso - 4M</title>
    </head>
                        ...
                        <tr>
                            <td style="padding: 45px 40px;">
                                ...
                                <p style="font-size: 16px; line-height: 1.7; color: #D8C6BE;">
                                    Hemos recibido un intento de inicio de sesión en tu cuenta de <strong style="color: #F1C40F;">4M</strong>.
                                </p>
                                <p style="font-size: 16px; line-height: 1.7; color: #D8C6BE;">
                                    Utiliza el siguiente código de acceso para completar tu autenticación:
                                </p>
                                ...
                                <p style="font-size: 14px; color: #A08D84; line-height: 1.6;">
                                    ⚠️ Este código es temporal y expirará en los próximos minutos por razones de seguridad.
                                </p>
                                <p style="font-size: 14px; color: #A08D84; line-height: 1.6; margin-top: 20px;">
                                    🔒 Si no intentaste iniciar sesión, ignora este mensaje. Tu cuenta permanece segura.
                                </p>
